    ...
    return (
      <div className="min-h-screen bg-[#020408] flex flex-col items-center justify-center relative overflow-hidden font-sans">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-xl font-mono text-cyan-400 mb-4 tracking-[0.5em] uppercase italic animate-pulse">
    ...
    <div className="min-h-screen bg-[#020408] text-white font-sans relative overflow-hidden pt-32 pb-24">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <header className="mb-32 text-center max-w-5xl mx-auto relative">
          ...
          <p className="text-cyan-500/40 font-mono text-[10px] tracking-[1.5em] uppercase">
            Authorized Access Only
          </p>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {/* SAFE MAPPING ADDED HERE */}
          {Array.isArray(services) && services.length > 0 ? (
                  ...
                  <div className="relative h-[45%] overflow-hidden border-b border-white/5">
                    ...
                    <div className="absolute top-6 left-6 z-20">
                      <div className="bg-black/80 border border-cyan-500/30 px-4 py-2 flex flex-col items-start gap-0.5">
                        <span className="text-[8px] font-mono text-cyan-500/60 uppercase tracking-widest leading-none">
                          Access_Fee
                        </span>
                        <span className="text-xl font-bold text-cyan-400 tracking-tighter font-mono">
                          ${service.price}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="p-10 flex flex-col flex-grow relative">
                    <div className="absolute -top-10 right-10">
                      <div className="w-16 h-16 bg-[#020408] border border-cyan-500/30 flex items-center justify-center rotate-45 group-hover:rotate-0 transition-all duration-700">
                        <Box
                          size={24}
                          className="text-cyan-500 -rotate-45 group-hover:rotate-0 transition-all duration-700"
                        />
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-[9px] font-mono text-white/30 uppercase tracking-[0.4em]">
                          Node_{service._id.slice(-6).toUpperCase()}
                        </span>
                      </div>
                    ...
                    <div className="mt-auto">
                      ...
                      >
                        ...
                        <div className="relative flex items-center justify-between px-6">
                          ...
                          <ArrowRight
                            size={18}
                            className="text-cyan-500 transition-transform duration-500 group-hover/btn:translate-x-2"
                          />
                        </div>
            ...
            <div className="col-span-full flex flex-col items-center justify-center py-20 border border-white/5 bg-white/5 backdrop-blur-sm">
              <Terminal size={40} className="text-cyan-500/50 mb-4" />
              <p className="text-cyan-500/60 font-mono tracking-widest text-sm">
                NO_DATA_FOUND_IN_CLUSTER
              </p>
            </div>
          )}
        </div>
