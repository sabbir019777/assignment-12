...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#05080a] text-white flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-[380px] perspective-1000 my-4">
        <div className="bg-[#0a1114]/90 backdrop-blur-3xl border border-cyan-500/20 rounded-[2rem] p-5 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden group hover:border-cyan-500/40 transition-all duration-700">
          ...
          <header className="text-center mb-4 relative">
            <div className="relative inline-flex mb-2">
              ...
              <div className="relative w-12 h-12 flex items-center justify-center bg-[#0d161a] border border-cyan-400/30 rounded-2xl rotate-45 group-hover:rotate-0 transition-transform duration-700">
                <Fingerprint size={24} className="text-cyan-400 -rotate-45 group-hover:rotate-0 transition-transform duration-700" />
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {[
              { icon: User, name: "name", placeholder: "FULL_NAME", type: "text" },
              { icon: ImageIcon, name: "photo", placeholder: "PHOTO_URL (Optional)", type: "url", notRequired: true },
              { icon: Mail, name: "email", placeholder: "EMAIL_ADDRESS", type: "email" },
              { icon: ShieldCheck, name: "nid", placeholder: "NID_IDENTIFIER", type: "text" },
              { icon: Phone, name: "contact", placeholder: "SECURE_CONTACT", type: "tel" }
            ].map((field, i) => (
              <div key={i} className="relative group/input">
                 <div className="relative">
                    <field.icon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within/input:text-cyan-400 transition-colors" size={14} />
                    <input
                      type={field.type}
                      name={field.name}
                      ...
                      className="w-full bg-[#0d161a] border border-white/5 p-2.5 pl-9 rounded-xl focus:outline-none focus:border-cyan-500/50 transition-all font-mono text-[10px] placeholder:text-gray-800"
                    />
                 </div>
              </div>
            ))}
            ...
            <div className="relative group/input">
               <div className="relative">
                  ...
                  <input
                    ...
                    pattern="^(?=.*[a-z])(?=.*[A-Z]).{6,}$"
                    onChange={handleChange}
                    className="w-full bg-[#0d161a] border border-white/5 p-2.5 pl-9 pr-8 rounded-xl focus:outline-none focus:border-cyan-500/50 transition-all font-mono text-[10px] placeholder:text-gray-800"
                  />
                  <button
                    type="button"
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-2 text-white group-hover/btn:text-[#05080a] font-black uppercase tracking-[0.2em] text-[10px]">
          ...
          <div className="mt-4">
            <div className="relative flex items-center justify-center mb-2">
              ...
              <span className="relative bg-[#0a1114] px-3 text-[7px] font-mono text-gray-600 uppercase tracking-[0.4em]">External_Sync</span>
            </div>
            
            <button 
              onClick={handleGoogleLogin}
              type="button"
              className="w-full flex items-center justify-center gap-2 py-2.5 bg-white/[0.02] border border-white/5 rounded-xl hover:bg-white/5 hover:border-cyan-500/30 transition-all group/google"
            >
              <Chrome size={14} className="text-gray-400 group-hover/google:text-red-400 transition-colors" />
              <span className="font-mono text-[9px] font-bold uppercase tracking-widest text-gray-400 group-hover/google:text-white">Google Login</span>
            </button>
          </div>
          ...
          <div className="mt-3 pt-3 border-t border-white/5 text-center">
            ...
            <Link href="/login" className="inline-flex items-center gap-1.5 mt-1.5 text-cyan-400 hover:text-white transition-all font-black group">
              <span className="text-[9px] uppercase tracking-[0.2em]">ACCESS_LOGINS</span>
